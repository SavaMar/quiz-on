<template>
  ...
  <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-white">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      <a href="https://www.on-running.com/" class="flex items-center">
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/On-cloud-logo-white-background.svg/1200px-On-cloud-logo-white-background.svg.png" class="ml-5 h-6 sm:h-9" alt="ON Logo">
          <!-- <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">ON</span> -->
      </a>
